...
import com.sitionix.forgeit.sqlite.internal.config.SqliteProperties;
...
@Component
public class SqliteGraphExecutor {
    ...
    public SqliteGraphExecutor(
            final EntityManagerFactory emf,
            final PlatformTransactionManager transactionManager,
            final SqliteProperties properties) {
        this.emf = emf;
