...
/**
 * Loads the default SQLite YAML settings when the module is present on the classpath.
 */
public class SqliteDefaultsEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {

    private static final String DEFAULT_RESOURCE = "forge-it-sqlite-default.yml";
    ...
    private void loadYaml(final String resourcePath, final ConfigurableEnvironment environment) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to load SQLite default file " + resourcePath, ex);
        }
    }
}
