package com.sitionix.forgeit.sqlite.internal.repository;
...
import com.sitionix.forgeit.sqlite.internal.domain.SqliteGraphBuilder;
import com.sitionix.forgeit.sqlite.internal.domain.SqliteGraphExecutor;
...
/**
 * Simple bridge exposing SQLite details to consumers.
 */
@Component
public class SqliteForge {
    ...
    public SqliteForge(final DbEntityFactory entityFactory,
    ...
    public DbGraphBuilder create() {
        return new SqliteGraphBuilder(this.entityFactory,
                this.graphExecutor);
    }
