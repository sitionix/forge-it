...
public final class SqliteDbGraphChain<E> implements DbGraphChain<E> {
    ...
    public <N> DbGraphChain<N> to(final DbContractInvocation<N> nextInvocation) {
        ...
        return new SqliteDbGraphChain<>(this.context,
                nextChain,
                nextInvocation,
                this.graphExecutor);
    }
