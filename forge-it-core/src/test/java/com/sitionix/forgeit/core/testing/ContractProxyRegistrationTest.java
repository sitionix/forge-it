...
class ContractProxyRegistrationTest {
    ...
    @Test
    void resolvesDependencyViaBeanFactory() throws NoSuchFieldException {
        final DependencyDescriptor descriptor = new DependencyDescriptor(
                InjectionTarget.class.getDeclaredField("tools"), true);
        assertThat(context.getAutowireCapableBeanFactory().resolveDependency(descriptor, null))
                .isSameAs(tools);
    }
